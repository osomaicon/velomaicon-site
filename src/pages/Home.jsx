...
const INSTAGRAM = 'https://instagram.com/velo_maicon'
const BEHOLD_FEED = 'https://feeds.behold.so/xOpzmYapnkeB3lVQPcFu'
const igFallback = [ig1, ig2, ig3, ig4]
...
export default function Home() {
  ...
  return (
    <div ref={ref}>
      ...
      {/* Instagram — feed real, conheça a marca pela bancada */}
      <section className="section-padding border-t border-brand-border">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 animate-on-scroll">
            <div>
              <Inscription>@velo_maicon no Instagram</Inscription>
              <h2 className="text-3xl md:text-4xl text-brand-ink mt-3">Conheça a marca pela bancada</h2>
              <p className="text-brand-silver leading-relaxed mt-3 max-w-xl">
                Reparos do dia a dia, antes e depois, bastidores e personalizações —
            ...
            <a
              ...
              className="shrink-0 inline-flex items-center gap-2 px-7 py-3.5 rounded-md bg-brand-orange text-brand-dark font-semibold backlight hover:bg-brand-orange-dark transition-colors"
            >
          ...
          <div className="animate-on-scroll">
            <InstagramFeed feedUrl={BEHOLD_FEED} profileUrl={INSTAGRAM} count={6} fallback={igFallback} />
          </div>
        </div>
      </section>
